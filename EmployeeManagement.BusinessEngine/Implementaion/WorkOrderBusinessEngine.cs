...
namespace EmployeeManagement.BusinessEngine.Implementaion
{
    public class WorkOrderBusinessEngine : IWorkOrderBusinessEngine
    {
        ...
        private readonly string _employeeRoleId; // Employee rolünün ID'si
        #endregion
        ...
        public WorkOrderBusinessEngine(IUnitOfWork unitOfWork, IMapper mapper)
        {
            ...
            _mapper = mapper;
            _employeeRoleId = "24fc1fa0-ebd8-4679-8b54-93d9a5bd349b";
        }
        ...
        public Result<List<WorkOrderVM>> GetAllWorkOrders()
        {
            ...
            if (data != null)
            {
                var returnData = data.Select(item => new WorkOrderVM()
                {
                    Id = item.Id,
        ...
        private string SetAssignEmployeeId()
        {
            var getWorkOrderList = _unitOfWork.workOrderRepository.GetAll(w => w.AssignEmployee.IsAdmin != true
