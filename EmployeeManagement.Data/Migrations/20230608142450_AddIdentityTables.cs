        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkOrderDescription = table.Column<string>(maxLength: 750, nullable: true),
                    WorkOrderStatus = table.Column<int>(nullable: false),
                    WorkOrderPoint = table.Column<double>(nullable: false),
                    PhotoPath = table.Column<string>(nullable: true),
                    WorkOrderNumber = table.Column<string>(maxLength: 35, nullable: true),
                    AssignEmployeeId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
